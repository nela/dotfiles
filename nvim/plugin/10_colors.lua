...
now(function()
  ...
  local cb = function()
    ...
    set_hl('FloatShadow', palette.fg0, palette.none)
    set_hl('FloatTitle', palette.orange, palette.none)
    set_hl('FloatFooter', palette.orange, palette.none)
    set_hl('FloatBorder', palette.fg0, palette.none)
